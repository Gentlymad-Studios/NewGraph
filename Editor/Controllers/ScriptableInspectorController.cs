...
namespace NewGraph {
    public class ScriptableInspectorController : InspectorControllerBase {
        ...
        private void CreateButtonClicked() {
            ...
            string uniqueFilename = Path.Combine(lastFolder, typeof(ScriptableGraphModel).Name + "." + fileEnding);
        ...
        private void LoadButtonClicked() {
            ...
            EditorGUIUtility.ShowObjectPicker<ScriptableGraphModel>(null, false, "", currentPickerWindow);
            pickerActive = true;
        }
        ...
        public override void CreateRenameGraphUI(IGraphModelData graph) {
            ScriptableGraphModel graphModel = graph as ScriptableGraphModel;
